...
![image.png](img/lopen-a.png)
同理，下图的 lbaba.a 符号表可以看出依赖的函数和导出的函数：
![image.png](img/lbaba-a.png)
把 test.c 编译后也可以看其目标文件的符号表：
![image.png](img/test-c.png)
...
![image.png](img/x509_get_not.png)
...
![image.png](img/symbol_prefix.png)
...
![image.png](img/re-compilation.png)
